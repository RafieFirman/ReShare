...
$emailMarginClass = $badgeData ? 'mt-0' : 'mt-8';
?>
  ...
  <div class="relative h-44 bg-cover bg-center"
    ...
    <div class="relative z-10 p-6 text-white">
      ...
      <div class="flex items-center justify-between gap-3">
        ...
        <?php if ($badgeData): ?>
          <div class="relative -translate-y-12 shrink-0 inline-flex items-center gap-2 px-3 py-1.5 bg-white/90 border border-[#3e5648] rounded-full text-[#3e5648]
      ...
      <p class="text-right text-sm transition-all duration-200 <?= $emailMarginClass ?>">
